import{_ as i,o as a,c as n,ac as t}from"./chunks/framework.DnBnwVZk.js";const g=JSON.parse('{"title":"String到底相不相等？String初始化及String.intern()方法浅析","description":"","frontmatter":{"date":"2020-01-14T00:00:00.000Z","categories":["JVM"],"tags":["String"],"publish":true},"headers":[],"relativePath":"views/java/jvm/string/StringEquals.md","filePath":"views/java/jvm/string/StringEquals.md","lastUpdated":1775714960000}'),h={name:"views/java/jvm/string/StringEquals.md"};function l(p,s,k,e,d,r){return a(),n("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1578960000000"},[...s[0]||(s[0]=[t(`<h1 id="string到底相不相等-string初始化及string-intern-方法浅析" tabindex="-1">String到底相不相等？String初始化及String.intern()方法浅析 <a class="header-anchor" href="#string到底相不相等-string初始化及string-intern-方法浅析" aria-label="Permalink to &quot;String到底相不相等？String初始化及String.intern()方法浅析&quot;">​</a></h1><h2 id="引言" tabindex="-1">引言 <a class="header-anchor" href="#引言" aria-label="Permalink to &quot;引言&quot;">​</a></h2><p>在各种面试题中经常见到类似下述的面试题</p><p>写出main方法的打印结果</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    class</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> test</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{        </span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    }</span></span></code></pre></div><p>答案为:</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">false</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">false</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">false</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">true</span></span></code></pre></div><p>此题要求对String类的引用有相关了解，提炼相关的要点如下</p><h2 id="要点列表" tabindex="-1">要点列表 <a class="header-anchor" href="#要点列表" aria-label="Permalink to &quot;要点列表&quot;">​</a></h2><ol><li>两个对象obj1和obj2，当且仅当obj1与obj2指向相同的引用(内存地址，对象地址)时，ojb1==obj2返回true，其他返回false</li><li>String初始化时，若采用String s = &quot;1&quot;;这种字面量直接赋值的形式，则过程为： 判断字符串常量池中是否有值与字面量相同的引用，有的话s指向这个引用指向的对象，否则在堆上新建值为字面量的String对象，s指向新建的对象,并在字符串常量池中存储对应的引用</li><li>String初始化时，若采用String s = new String(&quot;1&quot;);这种new对象的形式，或者使用其他带参构造器，则过程为： 在堆上新建字符串实例，值为相关值，s直接指向堆上新增的这个对象</li><li>String s = new String(&quot;1&quot;) + new String(&quot;1&quot;)等同于String s = new StringBuilder().append(&quot;1&quot;).append(&quot;1&quot;).toString();由于StringBuilder的toString方法也是调用的String的带参构造方法， 因此在引用处理时，结果与3相同</li><li>String类的intern()方法执行过程为:检查字符串常量区是否有相同值(hash)的引用，有的话返回此引用，否则将调用者放入字符串常量区，并返回调用者的引用</li></ol><h2 id="实际代码分析" tabindex="-1">实际代码分析 <a class="header-anchor" href="#实际代码分析" aria-label="Permalink to &quot;实际代码分析&quot;">​</a></h2><p>如下为上述代码及每一行的分析</p><div class="language-java vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">java</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    String s1 </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;1&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">+</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;1&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">+</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> String</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;1&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span></code></pre></div><pre><code>                                    ↓↓↓↓↓↓↓↓解析↓↓↓↓↓↓↓↓↓
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        System.out.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">println</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(s7 </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">==</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> s8);</span></span></code></pre></div><pre><code>    /*
        ...
        true
     */
</code></pre><h2 id="延申" tabindex="-1">延申 <a class="header-anchor" href="#延申" aria-label="Permalink to &quot;延申&quot;">​</a></h2><ol><li>由于使用有参构造器来初始化变量时，总会在堆上新建变量，因此在极限情况下，确有可能在初始化阶段造成OOM，解决方法是尽量使用字面量初始化字符串</li><li>String内部字符串常量区的实现方式不同，openjdk中，实现类似HashMap，当放入过多常量时，插入与查找也会产生部分性能损耗，因此，调用String的intern()方法也要看情况确定</li></ol>`,32)])])}const o=i(h,[["render",l]]);export{g as __pageData,o as default};
